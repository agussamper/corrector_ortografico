...
Contacto** get_contactos() {
  Contacto* contacto1 = contacto_crear("sergio", "340524894", 20);
  Contacto* contacto2 = contacto_crear("carlos", "34054564", 16);
  Contacto* contacto3 = contacto_crear("agustin", "340554644", 18);
  Contacto* contacto4 = contacto_crear("laura", "340521554", 25);
  Contacto* contacto5 = contacto_crear("maria", "340524564", 30);
  Contacto* contacto6 = contacto_crear("juan", "340524564", 22);
  Contacto* contacto7 = contacto_crear("marcela", "34054594", 21);
...
void test_tablahash() {
  ...
  printf("elems: %d\n", tablahash_nelems(th));
  assert(tablahash_nelems(th) == 6);
  assert(tablahash_capacidad(th) == 10);

  // sobreescribiendo contacto
  Contacto* sobrew = contacto_crear("sergio", "3402447818", 20);
